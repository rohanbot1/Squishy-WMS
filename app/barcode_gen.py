...
Printed on a Rollo direct-thermal printer: 2in x 1in label rolls fed one
...
# Layout budget for a 144pt x 72pt page: margins for thermal-print edge
...
def generate_label_sheet_pdf(items: list[dict], output_path: str) -> str:
    ...
    exactly 2in x 1in to match the Rollo roll -- no grid, the printer feeds
